...
Ud=1παπ+α2U2sinωtdωt=22πU2cosα=0.9U2cosα#2
...
T_b=\frac{1}{f_b}=7.6923\times{10}^{-5}s

其中\alpha_b 为降压斩波电路矩形波发生器占空比，T_b 为矩形波发生器周期。将其填入到仿真电路的脉冲发生器当中，如图 15 所示
...
Tc=Tsw=1fsw=3.571×10-5s#7

{f_r=f}\_o=175Hz

信号波的幅值相对（调制比）

βi=UoiUii=UrUc=68.57%#8
...
γ=ΔUlUo=Ulon-UloffUlon+Uloff#11
