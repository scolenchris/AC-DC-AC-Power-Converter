...
int32_T PowerElecCurriculumDesign_dda62cd9_1_ds_dxdelt_p ( const
NeDynamicSystem * sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput *
out ) { ( void ) t1 ; out -> mDXDELT_P . mNumCol = 62ULL ; out -> mDXDELT_P .
mNumRow = 0ULL ; out -> mDXDELT_P . mJc [ 0 ] = 0 ; out -> mDXDELT_P . mJc [
1 ] = 0 ; out -> mDXDELT_P . mJc [ 2 ] = 0 ; out -> mDXDELT_P . mJc [ 3 ] = 0
...
mDXDELT_P . mJc [ 62 ] = 0 ; ( void ) sys ; ( void ) out ; return 0 ; }
