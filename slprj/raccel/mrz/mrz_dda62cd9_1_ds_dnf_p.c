...
int32_T mrz_dda62cd9_1_ds_dnf_p ( const NeDynamicSystem * sys , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * out ) { static int32_T
_cg_const_1 [ 63 ] = { 0 , 0 , 0 , 0 , 0 , 1 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2
, 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 ,
2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2
, 2 , 2 , 2 , 2 , 3 , 3 , 3 , 3 , 3 , 3 } ; static int32_T _cg_const_2 [ 3 ]
= { 24 , 22 , 19 } ; ( void ) t1 ; out -> mDNF_P . mNumCol = 62ULL ; out ->
mDNF_P . mNumRow = 53ULL ; out -> mDNF_P . mJc [ 0 ] = _cg_const_1 [ 0 ] ;
...
_cg_const_1 [ 59 ] ; out -> mDNF_P . mJc [ 60 ] = _cg_const_1 [ 60 ] ; out ->
mDNF_P . mJc [ 61 ] = _cg_const_1 [ 61 ] ; out -> mDNF_P . mJc [ 62 ] =
_cg_const_1 [ 62 ] ; out -> mDNF_P . mIr [ 0 ] = _cg_const_2 [ 0 ] ; out ->
mDNF_P . mIr [ 1 ] = _cg_const_2 [ 1 ] ; out -> mDNF_P . mIr [ 2 ] =
_cg_const_2 [ 2 ] ; ( void ) sys ; ( void ) out ; return 0 ; }
